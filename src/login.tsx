...
const loginSchema = z.object({
  username: z
    .string()
    .min(3, "Username deve avere almeno 3 caratteri") // ho abbassato i caratteri minimi perche i dati di test sono corti
    .max(25, "Username troppo lungo")
    .regex(/^[a-zA-Z0-9_]+$/, "Solo lettere, numeri e underscore"),
  password: z
    .string()
    .min(6, "Password deve avere almeno 6 caratteri") // ho abbassato i caratteri minimi perche i dati di test sono corti
    .max(50, "Password troppo lunga")
    // tolgo le regole sulla password perche quella di prova e tutta minuscola
...
function Login({
  ...
  // stato per salvare il messaggio di errore
